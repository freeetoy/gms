...
public class CryptoUtils {
	...
	public static String md5(String msg) throws NoSuchAlgorithmException {
		...
		return CryptoUtils.byteToHexString(md.digest());
	}
	...
	public static String encryptAES(String msg) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException, InvalidParameterSpecException, UnsupportedEncodingException, BadPaddingException, IllegalBlockSizeException {
